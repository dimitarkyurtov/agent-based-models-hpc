/**
 * @file main.cpp
 * @brief Test 3: Game of Life with large grid (1000x1000).
 *
 * Runs Conway's Game of Life simulation with a 1000x1000 grid configuration
...
const std::string kCheckpointFile = "tests/game-of-life/checkpoints/test3.dat";
...
/**
 * @brief Main entry point for Test 3.
 *
 * Initializes a 1000x1000 Game of Life grid, runs the simulation for 100
 * timesteps, and saves checkpoints every 10 steps to the tests/game-of-life/
 * checkpoints/test3.dat file.
 *
