/**
 * @file main.cpp
 * @brief Test 1: Game of Life with small grid (100x100).
 *
 * Runs Conway's Game of Life simulation with a 100x100 grid configuration
...
const std::string kCheckpointFile = "tests/game-of-life/checkpoints/test1.dat";
...
/**
 * @brief Main entry point for Test 1.
 *
 * Initializes a 100x100 Game of Life grid, runs the simulation for 100
 * timesteps, and saves checkpoints every 10 steps to test1.dat file.
 *
