/**
 * @file main.cpp
 * @brief Test 5: Game of Life with tall grid (1200x300).
 *
 * Runs Conway's Game of Life simulation with a 1200x300 grid configuration
...
const std::string kCheckpointFile = "tests/game-of-life/checkpoints/test5.dat";
...
/**
 * @brief Main entry point for Test 5.
 *
 * Initializes a 1200x300 Game of Life grid, runs the simulation for 100
 * timesteps, and saves checkpoints every 10 steps to the tests/game-of-life/
 * checkpoints/test5.dat file.
 *
