/**
 * @file main.cpp
 * @brief Test 2: Game of Life with medium grid (500x500).
 *
 * Runs Conway's Game of Life simulation with a 500x500 grid configuration
...
const std::string kCheckpointFile = "tests/game-of-life/checkpoints/test2.dat";
...
/**
 * @brief Main entry point for Test 2.
 *
 * Initializes a 500x500 Game of Life grid, runs the simulation for 100
 * timesteps, and saves checkpoints every 10 steps to the tests/game-of-life/
 * checkpoints/test2.dat file.
 *
